        ...
        <div class="login-modal-content">
          ...
          <div class="login-form-fields">
            <div class="login-field-group">
              ...
              <input type="text" id="login-user-input" class="form-input login-input" placeholder="admin@gps.om / alkhoud@gps.om" autocomplete="username" />
            </div>
            ...
            <div class="login-field-group">
              ...
              <input type="password" id="login-pin-input" class="form-input login-input" placeholder="Enter PIN code (e.g. 1234)" maxlength="8" autocomplete="current-password" />
            </div>
          </div>
